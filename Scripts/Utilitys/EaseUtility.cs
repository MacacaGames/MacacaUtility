...
public class EaseUtility
{
    ...
    public static IEnumerator To(float start, float end, float duration, AnimationCurve ease, Action<float> OnUpdate, Action OnComplete = null, float delay = 0)
    {
        float t = 0f;
        OnUpdate?.Invoke(start);
        while (t < delay)
     ...
     public static IEnumerator To(Vector2 start, Vector2 end, float duration, EaseStyle ease, Action<Vector2> OnUpdate, Action OnComplete = null, float delay = 0)
    {
        float t = 0f;
        OnUpdate?.Invoke(start);
        while (t < delay)
    ...
    public static IEnumerator To(Vector2 start, Vector2 end, float duration, AnimationCurve ease, Action<Vector2> OnUpdate, Action OnComplete = null, float delay = 0)
    {
        float t = 0f;
        OnUpdate?.Invoke(start);
        while (t < delay)
    ...
    public static IEnumerator To(Vector3 start, Vector3 end, float duration, AnimationCurve ease, Action<Vector3> OnUpdate, Action OnComplete = null, float delay = 0)
    {
        float t = 0f;
        OnUpdate?.Invoke(start);
        while (t < delay)
